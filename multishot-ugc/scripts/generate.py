...
DEPLOYMENT_ID = "590262fd-7152-4269-8ab1-2b5b71a3d764"

DEFAULT_TEXT = "Explora distintas perspectivas de esta escena"


def get_api_key():
    """Get API key - uses MULTISHOT_API_KEY first, then COMFY_DEPLOY_API_KEY."""
    api_key = os.environ.get("MULTISHOT_API_KEY") or os.environ.get("COMFY_DEPLOY_API_KEY")
    if not api_key:
        raise ValueError(
            "MULTISHOT_API_KEY or COMFY_DEPLOY_API_KEY environment variable is required."
        )
    return api_key
